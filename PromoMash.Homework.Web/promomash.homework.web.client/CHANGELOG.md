...
- Create Angular project with ng: `ng new promomash.homework.web.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`promomash.homework.web.client.esproj`).
